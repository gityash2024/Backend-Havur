...
exports.view = exports.patientViseAdmissionList = exports.list = exports.add = void 0;
...
const add = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let is_doctor = yield _validation_1.Doctor.findOne({ _id: req.body.doctorId }).select({
        password: 0,
        verificationCode: 0,
        status: 0,
    });
    ...
    let admission = new _validation_1.Admission(lodash_1.default.pick(req.body, ["patientId", "doctorId"]));
    admission.admissionId = (0, autoGenerate_1.default)(8);
...
exports.list = list;
const patientViseAdmissionList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let admission = yield _validation_1.Admission.find({
        hospitalId: req.body.hid,
        status: true,
    })
        .populate("patientId", {
...
exports.patientViseAdmissionList = patientViseAdmissionList;
const view = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let admission = yield _validation_1.Admission.findOne({
        hospitalId: req.body.hid,
        _id: req.body.id,
    })
        .populate("patientId", {
