...
exports.associatedHospitals = exports.view = exports.list = void 0;
...
const list = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let result = {};
    if (pageNo === 1) {
        let totalRecords = yield _validation_1.Doctor.find().countDocuments();
        result.totalRecords = totalRecords;
    }
    result.doctor = yield _validation_1.Doctor.find({ $and: [filter] })
        .select({
        password: 0,
        otp: 0,
        status: 0,
...
const view = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (error)
        throw error;
    const doctor = yield _validation_1.Doctor.findOne({ _id: req.body.did })
        .select({
        password: 0,
        otp: 0,
        status: 0,
