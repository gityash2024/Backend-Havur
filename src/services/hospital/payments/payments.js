...
const list = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let payment = yield _validation_1.Payments.find({
...
const add = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (error)
        throw error;
    let payment = new _validation_1.Payments(lodash_1.default.pick(req.body, ["accountId", "payTo", "amount", "description"]));
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (error)
        throw error;
    let payment = yield _validation_1.Payments.findOne({
        _id: req.body.id,
        hospitalId: req.body.hid,
    });
    if (!payment)
        return res.status(400).json({ message: "No record found." });
    payment = lodash_1.default.assign(payment, lodash_1.default.pick(req.body, ["accountId", "payTo", "amount", "description"]));
    payment.paymentDate = new Date(req.body.paymentDate).toISOString();
    payment.hospitalId = req.body.hid;
    payment.updatedAt = new Date().toISOString();
    payment = yield payment.save();
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield _validation_1.Payments.deleteOne({ _id: req.body.id, hospitalId: req.body.hid });
